    ...
    <footer className="bg-background border-t py-8 mt-auto">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-3 gradient-text">Portfolio</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/projects" className="text-sm text-foreground/80 hover:text-primary transition-colors">
                  Projects
                </Link>
              </li>
              <li>
